...
public class InsurancePaymentSend2 {
    private String polis_number, insurance, grade, rekening_number, full_name, status_fee;
    private Date date_insurance_payment;
    private Time time_insurance_payment;
    private BigDecimal insurance_fee;

    public InsurancePaymentSend2() {

    }

    public InsurancePaymentSend2(String rekening_number, String insurance, String polis_number, String full_name,
